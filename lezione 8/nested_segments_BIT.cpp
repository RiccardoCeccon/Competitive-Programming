...
We scan the l vector in decreasing order and we add 1 to the position r in a BIT. We sum thanks to the BIT from 0 to r-1 to get the number of nested segments.
